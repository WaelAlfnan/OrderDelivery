...
namespace OrderDelivery.Api.Controllers
{
    ...
    public class RegistrationStepsController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(ApiResponse<PendingRegistrationResponseDto>), 200)]
        ...
        public async Task<IActionResult> GetPendingRegistration(string phoneNumber)
        {
            try
            {
                ...
                {
                    return Ok(new ApiResponse<PendingRegistrationResponseDto>(pendingRegistration, "Pending registration found", true));
                }
        ...
        /// </summary>
        [HttpPost("complete-pending-registration")]
        [ProducesResponseType(typeof(ApiResponse<object>), 200)]
        [ProducesResponseType(typeof(ApiResponse<object>), 400)]
        public async Task<IActionResult> CompleteRegistration([FromBody] CompleteRegistrationDto dto)
        {
            try
            {
                ...
                var success = await _registrationStepsService.CompleteRegistrationAsync(dto.PhoneNumber);
