...
using OrderDelivery.Infrastructure.Validators;
            ...
            IConfiguration configuration)
        {
            try
            {
                ...
                services.AddIdentity<ApplicationUser, IdentityRole<Guid>>(options =>
                {
                    ...
                    // User settings - Allow phone numbers as usernames
                    options.User.AllowedUserNameCharacters = "0123456789+";
                    options.User.RequireUniqueEmail = false; // Remove email requirement

                    // SignIn settings - Use phone number instead of email
                ...
                .AddUserValidator<PhoneNumberBasedUserValidator<ApplicationUser>>(); // Add custom user validator
