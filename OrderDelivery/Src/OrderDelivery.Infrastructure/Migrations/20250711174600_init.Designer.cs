...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderDelivery.Domain.Entities.Admin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("CanManageMerchants")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("OrderDelivery.Domain.Entities.Admin", b =>
                {
                    b.HasOne("OrderDelivery.Domain.Entities.ApplicationUser", "AppUser")
                        .WithOne("Admin")
                        .HasForeignKey("OrderDelivery.Domain.Entities.Admin", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
