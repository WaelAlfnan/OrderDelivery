...
namespace OrderDelivery.Infrastructure.Migrations
{
    ...
    [Migration("20250822134008_AddRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderDelivery.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OrderDelivery.Domain.Entities.Vehicle", b =>
                {
                    ...
                    b.Property<string>("VehicleIssueDate")
                        .IsRequired()
                        .HasMaxLength(4)
            ...
            modelBuilder.Entity("OrderDelivery.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("OrderDelivery.Domain.Entities.ApplicationUser", "ApplicationUser")
