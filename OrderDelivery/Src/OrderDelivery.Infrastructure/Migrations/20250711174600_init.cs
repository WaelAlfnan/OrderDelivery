        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalIdFrontPhotoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    NationalIdBackPhotoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CanManageMerchants = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CanManageDrivers = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CanManageOrders = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CanViewReports = table.Column<bool>(type: "bit", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentLatitude = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    CurrentLongitude = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    StoreLatitude = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    StoreLongitude = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    Rating = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false, defaultValue: 0m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Merchants_Users_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Residences_Drivers_DriverId",
                        column: x => x.DriverId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShasehPhotoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    EfragPhotoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    VehicleIssueDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EvaluatorApplicationUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RatedApplicationUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ratings_Users_EvaluatorApplicationUserId",
                        column: x => x.EvaluatorApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_Users_RatedApplicationUserId",
                        column: x => x.RatedApplicationUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drivers_CurrentLatitude_CurrentLongitude",
                table: "Drivers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Merchants_StoreLatitude_StoreLongitude",
                table: "Merchants",
                columns: new[] { "StoreLatitude", "StoreLongitude" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_MessageType",
                table: "Notifications",
                column: "MessageType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_EvaluatorApplicationUserId",
                table: "Ratings",
                column: "EvaluatorApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_RatedApplicationUserId",
                table: "Ratings",
                column: "RatedApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Residences_DriverId",
                table: "Residences",
                column: "DriverId",
                unique: true);
